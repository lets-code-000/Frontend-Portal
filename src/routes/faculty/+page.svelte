<script lang="ts">
	...
	let faculties: NonNullable<typeof data.faculties> = $state([]);
	$effect(() => { faculties = data.faculties ?? []; });
...
<div class="min-h-screen bg-gray-100 p-8">
	<div class="mx-auto max-w-7xl">
		<PageHeader title="Faculties" subtitle="Manage all faculties" Icon={GraduationCap} />

		<div class="rounded-lg bg-white p-6 shadow-md">
			<div class="mb-4 flex items-center justify-between">
				<h2 class="text-2xl font-semibold">All Faculties</h2>
				<Button href="/faculty/create">
					<Plus class="h-4 w-4" />
					Create
				</Button>
			</div>
